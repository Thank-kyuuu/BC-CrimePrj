...
set -x
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile $ORDERER_CA -C $CHANNEL_NAME -n ${CC_NAME} $PEER_CONN_PARMS -c '{"function":"RegistCrime","Args":["7881","jin","12345678","dx91jv9dls","1231141151","1","fatal crime"]}' >&log.txt
{ set +x; } 2>/dev/null
cat log.txt
sleep 3
